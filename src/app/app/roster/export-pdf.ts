...
export function exportRosterPdf(
  ...
  branding?: { tenantName?: string | null; tenantLogoUrl?: string | null }
) {
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .brand-tenant { font-size: 10px; color: #6b7280; margin-top: 2px; }
    .title-block { text-align: right; }
    .title-block h1 { font-size: 14px; font-weight: 600; color: #1f2937; }
    .title-block .meta { font-size: 10px; color: #6b7280; margin-top: 2px; }
...
<body>
  <div class="page-header">
    <div class="brand">
      ${branding?.tenantLogoUrl ? `<img src="${branding.tenantLogoUrl}" alt="${branding?.tenantName ?? ""}" class="brand-logo" />` : ""}
      <div class="brand-text">
        <div class="brand-mark">ShiftOps</div>
        ${branding?.tenantName ? `<div class="brand-tenant">${branding.tenantName}</div>` : ""}
      </div>
    </div>
  ...
  <div class="footer-mark">Generated by ShiftOps · shiftops.co.za</div>
</body>
</html>
`;

...
export function CashupForm({
  ...
  return (
    <div className="flex gap-6 items-start">
      {/* Main form */}
      <div className="flex-1 max-w-[640px] space-y-0 pb-32 md:pb-8">
        {/* ── Section 1: Takings ─────────────────────────────────────── */}
        <SectionHeader title="Takings" first />
        ...
        <SectionHeader title="Delivery Drivers" />
        ...
        {/* ── Section 4: Transaction Counts ──────────────────────────── */}
        <SectionHeader title="Transaction Counts" />
...
function SectionHeader({
  ...
  return (
    <div className={cn(!first && "border-t border-base-200", "py-4")}>
